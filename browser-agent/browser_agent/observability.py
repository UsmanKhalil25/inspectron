# @file purpose: Observability module for browser-agent that handles optional lmnr integration with debug mode support
"""
Observability module for browser-agent
...
try:
	...
	if os.environ.get('BROWSER_AGENT_VERBOSE_OBSERVABILITY', 'false').lower() == 'true':
...
def observe_debug(
	...
	**kwargs: Any,
	...
	- BROWSER_AGENT_DEBUG environment variable set to 1/true/yes/on
