...
from browser_agent.browser.events import BrowserConnectedEvent, BrowserStopEvent
...
class HarRecordingWatchdog(BaseWatchdog):
	...
	async def _write_har(self) -> None:
		...
		try:
			bu_version = importlib_metadata.version('browser-agent')
		except Exception:
		...
		har_obj = {
			'log': {
				'version': '1.2',
				'creator': {'name': 'browser-agent', 'version': bu_version},
