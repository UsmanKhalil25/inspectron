...
from browser_agent.agent.views import AgentHistoryList
from browser_agent.browser.views import PLACEHOLDER_4PX_SCREENSHOT
...
def create_history_gif(
	...
	if show_logo:
		try:
			logo = Image.open('./static/browser-agent.png')
