...
from browser_agent.agent.prompts import AgentMessagePrompt
from browser_agent.browser import BrowserProfile, BrowserSession
from browser_agent.browser.events import ClickElementEvent, TypeTextEvent
from browser_agent.browser.profile import ViewportSize
from browser_agent.dom.service import DomService
from browser_agent.dom.views import DEFAULT_INCLUDE_ATTRIBUTES
...
async def test_focus_vs_all_elements():
	...
	sample_websites = [
		'https://browser-agent.github.io/stress-tests/challenges/iframe-inception-level2.html',
		'https://www.google.com/travel/flights',
		'https://v0-simple-ui-test-site.vercel.app',
		'https://browser-agent.github.io/stress-tests/challenges/iframe-inception-level1.html',
		'https://browser-agent.github.io/stress-tests/challenges/angular-form.html',
		'https://www.google.com/travel/flights',
	...
	# Show startup info
	print('\n🌐 BROWSER-AGENT DOM EXTRACTION TESTER')
