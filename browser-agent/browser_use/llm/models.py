...
def __getattr__(name: str) -> 'BaseChatModel':
	...
	if name == 'ChatOpenAI':
		...
		if not OCI_AVAILABLE:
			raise ImportError('OCI integration not available. Install with: pip install "browser-agent[oci]"')
...
# so this module can be imported without browser-agent[oci] installed.
