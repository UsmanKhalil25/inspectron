...
from browser_agent.llm.messages import (
	AssistantMessage,
	BaseMessage,
	SystemMessage,
	UserMessage,
...
if TYPE_CHECKING:
	...
	from browser_agent.llm.aws.chat_anthropic import ChatAnthropicBedrock
	from browser_agent.llm.aws.chat_bedrock import ChatAWSBedrock
	from browser_agent.llm.azure.chat import ChatAzureOpenAI
	from browser_agent.llm.browser_agent.chat import ChatBrowserUse
	from browser_agent.llm.cerebras.chat import ChatCerebras
	from browser_agent.llm.deepseek.chat import ChatDeepSeek
	...
	from browser_agent.llm.openrouter.chat import ChatOpenRouter
...
_LAZY_IMPORTS = {
	...
	'ChatAnthropicBedrock': ('browser_agent.llm.aws.chat_anthropic', 'ChatAnthropicBedrock'),
	'ChatAWSBedrock': ('browser_agent.llm.aws.chat_bedrock', 'ChatAWSBedrock'),
	...
	'ChatCerebras': ('browser_agent.llm.cerebras.chat', 'ChatCerebras'),
	'ChatDeepSeek': ('browser_agent.llm.deepseek.chat', 'ChatDeepSeek'),
	...
	'ChatOpenRouter': ('browser_agent.llm.openrouter.chat', 'ChatOpenRouter'),
...
def __getattr__(name: str):
	...
	try:
		from browser_agent.llm.models import __getattr__ as models_getattr
